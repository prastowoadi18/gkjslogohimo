  ...
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <p className="font-semibold">Tentang Pepanthan</p>
      </div>
      <h1 className="mt-2 lg:mt-10 text-2xl lg:text-xl font-semibold">
        Pepanthan GKJ Slogohimo
      </h1>
          ...
          {Array.from({ length: 3 }).map((e: any, idx) => (
            ...
            >
              ...
              <div className="px-6 py-4">
                <div className="font-bold text-lg">Pepanthan Jatisrono</div>
              ...
              <div className="px-6 pt-4 pb-5">
                <Link
                  href={`/tentang/pepanthan/${"jatisrono"}`}
...
export default TentangPepanthanPage;
