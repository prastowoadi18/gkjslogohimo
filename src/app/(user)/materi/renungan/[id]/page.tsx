...
const RenunganDetailPage = ({ params }: { params: { id: string } }) => {
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <Link href="/materi/renungan" className="hover:text-blue-500">
          Renungan
        </Link>
        <span className="">/</span>
        <p className="font-semibold">Renungan Lorem ipsum dolor sit amet</p>
      </div>
      <div className="py-5">
