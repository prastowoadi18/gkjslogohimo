...
const KurikulumAnakDetailPage = ({ params }: { params: { id: string } }) => {
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <p className="font-semibold">
          Kurikulum Anak Lorem ipsum dolor sit amet
        </p>
      </div>
      ...
      <div className="pt-10 pb-20">
        ...
        <Link
          href="/materi/kurikulum/anak"
          className={buttonVariants({ size: "sm", className: "mt-10" })}
        >
          Lihat Kurikulum Anak Lainnya
        </Link>
      </div>
    </MaxWidthWrapper>
  );
...
export default KurikulumAnakDetailPage;
