  ...
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <p className="font-semibold">Materi Khotbah</p>
      </div>
      <h1 className="mt-2 lg:mt-10 text-2xl lg:text-xl font-semibold">
        Materi Khotbah GKJ Slogohimo
      </h1>
          ...
          {Array.from({ length: 3 }).map((e: any, idx) => (
            ...
            >
              ...
              <div className="px-6 py-4">
                <div className="font-bold text-lg">{`Khotbah ${idx + 1}`}</div>
                <div className="mb-4">
...
export default MateriKhotbahPage;
