...
const KhotbahDetailPage = ({ params }: { params: { id: string } }) => {
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <Link href="/materi/khotbah" className="hover:text-blue-500">
          Materi Khotbah
        </Link>
        <span className="">/</span>
        <p className="font-semibold">Khotbah Lorem ipsum dolor sit amet</p>
      </div>
      <div className="lg:py-5">
        <div className="relative rounded-md">
          ...
          <div className="absolute top-5 left-4  rounded-md">
...
export default KhotbahDetailPage;
