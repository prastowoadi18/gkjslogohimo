...
const KurikulumRemajaPemudaDetailPage = ({
  params,
}: {
  params: { id: string };
}) => {
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <Link href="/materi/kurikulum/anak" className="hover:text-blue-500">
          Kurikulum Remaja & Pemuda
        </Link>
        <span className="">/</span>
        <p className="font-semibold">
          Kurikulum Remaja & Pemuda Lorem ipsum dolor sit amet
        </p>
      </div>
      <div className="lg:py-5">
        <div className="relative w-full rounded-md">
          ...
          <div className="absolute bottom-5 left-4">
            <Link
              href="https://drive.google.com/uc?export=download&id=1G7Cx4y37BhkW6iBRRSg4GevW53Qclkh9"
      ...
      <div className="pt-10 pb-20">
        ...
        <Link
          href="/materi/kurikulum/remaja_pemuda"
          className={buttonVariants({ size: "sm", className: "mt-10" })}
        >
          Lihat Kurikulum Remaja & Pemuda Lainnya
        </Link>
      </div>
    </MaxWidthWrapper>
  );
...
export default KurikulumRemajaPemudaDetailPage;
