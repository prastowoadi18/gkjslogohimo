...
const KurikulumPemudaRemajaPage = () => {
  return (
    <MaxWidthWrapper className="py-5">
      <div className="hidden lg:flex space-x-2 text-muted-foreground text-base">
        ...
        <span className="">/</span>
        <p className="font-semibold">Kurikulum Remaja & Pemuda</p>
      </div>
      <h1 className="mt-2 lg:mt-10 text-2xl lg:text-xl font-semibold">
        Kurikulum Remaja & Pemuda GKJ Slogohimo
      </h1>
          ...
          {Array.from({ length: 3 }).map((e: any, idx) => (
            ...
            >
              ...
              <div className="px-6 pt-2 pb-5">
                <Link
                  href={`/materi/kurikulum/remaja_pemuda/1`}
...
export default KurikulumPemudaRemajaPage;
