            ...
            <div className="">
              ...
              <div className="mt-5 lg:mt-10">
                ...
                >
                  ...
                  <p className="text-base text-gray-600 group-hover:text-blue-500 group-hover:transition-all group-hover:duration-300 dark:text-gray-300">
              ...
              <div className="mt-5 lg:mt-10">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div className="flex flex-col">
                    <Link
                      href="/#berita_terbaru"
                      className="mb-3 text-base text-gray-600 transition-all duration-300 hover:text-blue-500 dark:text-gray-300"
                    >
                      Berita Terbaru
                    </Link>
                    <Link
                    ...
                    <Link
                      href="/berita"
                      className="text-base text-gray-600 transition-all duration-300 hover:text-blue-500 dark:text-gray-300"
                    >
                      Berita
                    </Link>
                  </div>
